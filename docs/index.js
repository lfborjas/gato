...
(function($PS) {
  ...
  var showMarker = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at TicTacToe (line 17, column 1 - line 19, column 15): " + [ v.constructor.name ]);
  });
  var showGameOver = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at TicTacToe (line 30, column 1 - line 32, column 49): " + [ v.constructor.name ]);
  });
  var next = function (v) {
      if (v instanceof X) {
          return O.value;
      ...
      throw new Error("Failed pattern match at TicTacToe (line 47, column 1 - line 47, column 25): " + [ v.constructor.name ]);
  };
  var markerAt = function (v) {
      return function (board) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_List.index(board)(v.value0))(function (row) {
              return Data_Maybe.fromMaybe(Data_Maybe.Nothing.value)(Data_List.index(row)(v.value1));
          });
      };
  };
  var isTie = (function () {
      var $31 = Data_List.filter(Data_Maybe.isNothing);
      return function ($32) {
          return Data_List["null"]($31(Data_List.concat($32)));
      };
  })();
  ...
  var rowVictor = function (r) {
      var occupied = Data_List.catMaybes(r);
      var $22 = Data_List.length(occupied) === 3 && Data_List.length(Data_List.nub(eqMarker)(occupied)) === 1;
      if ($22) {
          return Data_List.head(occupied);
      };
      return Data_Maybe.Nothing.value;
  };
  var findWinner = function (board) {
      var diagonals = [ Data_Functor.map(Data_List_Types.functorList)(function (i) {
          return markerAt(new Data_Tuple.Tuple(i, i))(board);
      })(Data_List.range(0)(2)), Data_Functor.map(Data_List_Types.functorList)(function (i) {
          return markerAt(new Data_Tuple.Tuple(i - 1 | 0, 3 - i | 0))(board);
      })(Data_List.range(1)(3)) ];
      var cols = Data_List.transpose(board);
      return Control_Alt.alt(Data_Maybe.altMaybe)(Control_Alt.alt(Data_Maybe.altMaybe)(Data_Foldable.findMap(Data_List_Types.foldableList)(rowVictor)(board))(Data_Foldable.findMap(Data_List_Types.foldableList)(rowVictor)(cols)))(Data_Foldable.findMap(Data_Foldable.foldableArray)(rowVictor)(diagonals));
  };
  ...
  var playAt = function (v) {
      return function (v1) {
          var updateState = function (updatedBoard) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  currentTurn: next(v1.currentTurn),
                  board: updatedBoard,
                  outcome: determineOutcome(updatedBoard)
              });
          };
          var tileIsFree = function (_g) {
              return Data_Maybe.maybe(Control_Applicative.pure(Data_Either.applicativeEither)(v1))(Data_Function["const"](Data_Either.Left.create("Invalid move")))(markerAt(v)(v1.board));
          };
          var stillInProgress = function (_g) {
              return Data_Maybe.maybe(Control_Applicative.pure(Data_Either.applicativeEither)(v1))(Data_Function["const"](Data_Either.Left.create("Game over!")))(v1.outcome);
          };
          var makeMove = function (_g) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid row")(Data_List.index(v1.board)(v.value0)))(function (row) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid column")(Data_List.updateAt(v.value1)(new Data_Maybe.Just(v1.currentTurn))(row)))(function (updatedRow) {
                      return Data_Either.note("Invalid row")(Data_List.updateAt(v.value0)(updatedRow)(v1.board));
                  });
              });
          };
          return Control_Bind.bind(Data_Either.bindEither)(Control_Bind.bind(Data_Either.bindEither)(Control_Bind.bind(Data_Either.bindEither)(stillInProgress(v1))(tileIsFree))(makeMove))(updateState);
      };
  };
  var blankBoard = (function () {
      var row = Data_Unfoldable.replicate(Data_List_Types.unfoldableList)(3)(Data_Maybe.Nothing.value);
      var rows = Data_Unfoldable.replicate(Data_List_Types.unfoldableList)(3)(row);
      return rows;
  })();
  exports["X"] = X;
  exports["Tied"] = Tied;
  ...
  var render = function (state) {
      ...
      var renderCell = function (row) {
          return function (col) {
              ...
              }) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(Data_Show.show(TicTacToe.showMarker))(TicTacToe.markerAt(new Data_Tuple.Tuple(row, col))(state.board))) ]);
          };
      };

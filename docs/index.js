...
(function($PS) {
  "use strict";
  $PS["TicTacToe"] = $PS["TicTacToe"] || {};
  var exports = $PS["TicTacToe"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Victory = (function () {
      function Victory(value0) {
          this.value0 = value0;
      };
      Victory.create = function (value0) {
          return new Victory(value0);
      };
      return Victory;
  })();
  var showMarker = new Data_Show.Show(function (v) {
      if (v instanceof X) {
          return "X";
      };
      if (v instanceof O) {
      ...
      throw new Error("Failed pattern match at TicTacToe (line 18, column 1 - line 20, column 15): " + [ v.constructor.name ]);
  });
  var showGameOver = new Data_Show.Show(function (v) {
      if (v instanceof Tied) {
          return "It's a tie!";
      };
      if (v instanceof Victory) {
          return "The winner is: " + Data_Show.show(showMarker)(v.value0);
      };
      throw new Error("Failed pattern match at TicTacToe (line 31, column 1 - line 33, column 49): " + [ v.constructor.name ]);
  });
  var next = function (v) {
      if (v instanceof X) {
          return O.value;
      ...
      throw new Error("Failed pattern match at TicTacToe (line 48, column 1 - line 48, column 25): " + [ v.constructor.name ]);
  };
  var markerAt = function (v) {
      return function (board) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(board)(v.value0))(function (row) {
              return Data_Maybe.fromMaybe(Data_Maybe.Nothing.value)(Data_Array.index(row)(v.value1));
          });
      };
  };
  var isTie = (function () {
      var $31 = Data_Array.filter(Data_Maybe.isNothing);
      return function ($32) {
          return Data_Array["null"]($31(Data_Array.concat($32)));
      };
  })();
  var eqMarker = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  var ordMarker = new Data_Ord.Ord(function () {
      return eqMarker;
  }, function (x) {
      return function (y) {
          if (x instanceof X && y instanceof X) {
          ...
          throw new Error("Failed pattern match at TicTacToe (line 16, column 1 - line 16, column 40): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var winsRow = function (r) {
      var occupied = Data_Array.catMaybes(r);
      var $22 = Data_Array.length(occupied) === 3 && Data_Array.length(Data_Array.nub(ordMarker)(occupied)) === 1;
      if ($22) {
          return Data_Array.head(occupied);
      };
      return Data_Maybe.Nothing.value;
  };
  var findWinner = function (board) {
      var diagonals = [ Data_Functor.map(Data_Functor.functorArray)(function (i) {
          return markerAt(new Data_Tuple.Tuple(i, i))(board);
      })(Data_Array.range(0)(2)), Data_Functor.map(Data_Functor.functorArray)(function (i) {
          return markerAt(new Data_Tuple.Tuple(i - 1 | 0, 3 - i | 0))(board);
      })(Data_Array.range(1)(3)) ];
  ...
  var cols = Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Data_Array.fromFoldable(Data_List_Types.foldableList))(Data_List.transpose(Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Data_List.fromFoldable(Data_Foldable.foldableArray))(board)))));
      return Control_Alt.alt(Data_Maybe.altMaybe)(Control_Alt.alt(Data_Maybe.altMaybe)(Data_Foldable.findMap(Data_Foldable.foldableArray)(winsRow)(board))(Data_Foldable.findMap(Data_Foldable.foldableArray)(winsRow)(cols)))(Data_Foldable.findMap(Data_Foldable.foldableArray)(winsRow)(diagonals));
  };
  var determineOutcome = function (board) {
      var $23 = isTie(board);
      if ($23) {
          return new Data_Maybe.Just(Tied.value);
      };
      return Data_Functor.map(Data_Maybe.functorMaybe)(Victory.create)(findWinner(board));
  };
  var playAt = function (v) {
      return function (v1) {
          var nextTurn = next(v1.currentTurn);
          return Control_Bind.bind(Data_Either.bindEither)(Data_Maybe.maybe(Control_Applicative.pure(Data_Either.applicativeEither)(Data_Unit.unit))(Data_Function["const"](Data_Either.Left.create("Game over!")))(v1.outcome))(function (gameOver) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Maybe.maybe(Control_Applicative.pure(Data_Either.applicativeEither)(Data_Unit.unit))(Data_Function["const"](Data_Either.Left.create("Invalid move")))(markerAt(v)(v1.board)))(function (occupied) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid row")(Data_Array.index(v1.board)(v.value0)))(function (row) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid column")(Data_Array.updateAt(v.value1)(new Data_Maybe.Just(v1.currentTurn))(row)))(function (updatedRow) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid row")(Data_Array.updateAt(v.value0)(updatedRow)(v1.board)))(function (updatedBoard) {
                              return Control_Applicative.pure(Data_Either.applicativeEither)({
                                  currentTurn: nextTurn,
                                  board: updatedBoard,
                                  outcome: determineOutcome(updatedBoard)
                              });
                          });
                      });
                  });
  ...
  var blankBoard = (function () {
      var row = Data_Array.replicate(3)(Data_Maybe.Nothing.value);
      var rows = Data_Array.replicate(3)(row);
      return rows;
  })();
  exports["X"] = X;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["App.GameBoard"] = $PS["App.GameBoard"] || {};
  var exports = $PS["App.GameBoard"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var TicTacToe = $PS["TicTacToe"];                
  var MarkAt = (function () {
      function MarkAt(value0) {
          this.value0 = value0;
      };
      MarkAt.create = function (value0) {
          return new MarkAt(value0);
      };
      return MarkAt;
  })();
  var StartOver = (function () {
      ...
      StartOver.value = new StartOver();
      return StartOver;
  })();
  var render = function (state) {
      var status = (function () {
          var $12 = Data_Maybe.isJust(state.outcome);
          if ($12) {
              return Halogen_HTML_Core.text(Data_Maybe.maybe("")(Data_Show.show(TicTacToe.showGameOver))(state.outcome));
          };
          return Halogen_HTML_Core.text("Current turn: " + Data_Show.show(TicTacToe.showMarker)(state.currentTurn));
      })();
      var startOver = function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.span_([  ]);
          };
          return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
              return new Data_Maybe.Just(StartOver.value);
          }) ])([ Halogen_HTML_Core.text("Start Over") ]);
      };
      var markIfEmpty = function (pos) {
          var v = TicTacToe.markerAt(pos)(state.board);
          if (v instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Just.create(new MarkAt(pos));
          };
          if (v instanceof Data_Maybe.Just) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at App.GameBoard (line 54, column 7 - line 56, column 26): " + [ v.constructor.name ]);
      };
      var renderCell = function (row) {
          return function (col) {
              return Halogen_HTML_Elements.td([ Halogen_HTML_Events.onClick(function (v) {
                  return markIfEmpty(new Data_Tuple.Tuple(row, col));
              }) ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Show.show(TicTacToe.showMarker))(TicTacToe.markerAt(new Data_Tuple.Tuple(row, col))(state.board)))) ]);
          };
      };
      var renderRow = function (ix) {
      ...
      return Halogen_HTML_Elements.div_([ status, Halogen_HTML_Elements.table_(renderRows), startOver(state.outcome) ]);
  };
      ...
      return function (v) {
          ...
          if (v instanceof MarkAt) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  var v1 = TicTacToe.playAt(v.value0)(st);
                  if (v1 instanceof Data_Either.Left) {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Error: " + v1.value0));
                  };
                  ...
                  throw new Error("Failed pattern match at App.GameBoard (line 64, column 5 - line 67, column 84): " + [ v1.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at App.GameBoard (line 59, column 16 - line 67, column 84): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadEffect) {
      return Halogen_Component.mkComponent({
          initialState: function (v) {
              return {
                  currentTurn: TicTacToe.X.value,
                  board: TicTacToe.blankBoard,
                  outcome: Data_Maybe.Nothing.value
              };
          },
          render: render,
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_GameBoard = $PS["App.GameBoard"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(App_GameBoard.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();